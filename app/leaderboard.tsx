...
export default function LeaderboardScreen() {
  ...
  const calculateLeaderboard = () => {
    try {
      setLoading(true)
      if (paccounts.data) {
        // Group participants by user and sum their points
        const userStats = new Map<string, { points: number; campaigns: Set<string> }>()

        paccounts.data.forEach((participant: any) => {
      ...
      Alert.alert(
        ...
        [
          { text: 'Cancel', style: 'cancel' },
          {
            text: 'Verify',
            onPress: () => {
              // Here you would integrate with Reclaim Protocol
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Participate in campaigns to appear on the leaderboard!
            </Text>
          </View>
        }
      />
